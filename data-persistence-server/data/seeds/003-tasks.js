...
exports.seed = async function(knex) {
  ...
  await knex('tasks').truncate().insert([
    {'task-description': 'Pay a visit to Bilbo', 'task-notes': 'Convince Bilbo to handover the ring', 'task-completed': false, 'project-id': 1},
    ...
    {'task-description': 'Ask Sam to Accompany Frodo', 'task-notes': 'Tell Sam never to leave Frodo\'s side', 'task-completed': false, 'project-id': 1},
    {'task-description': 'Tell Bilbo about an Adventure', 'task-notes': 'Pique Bilbo\'s interest', 'task-completed': true, 'project-id': 2},
    {'task-description': 'Mark the door for dwarfs', 'task-notes': 'Marking the door will help dwarfs reach Bilbo', 'task-completed': false, 'project-id': 2},
